        ...
        child: Column(
          ...
          children: [
            ...
            Autocomplete<Map<String, String>>(
              ...
              fieldViewBuilder: (context, controller, focusNode, onEditingComplete) { return TextField(controller: controller, focusNode: focusNode, decoration: const InputDecoration(labelText: 'Comune (es. Vicenza)', border: OutlineInputBorder()), onChanged: (val) => provider.aggiornaDato(nuovoComune: val)); },
            ),
            const SizedBox(height: 16),
            Row(children: [
